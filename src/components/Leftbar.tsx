...
const Leftbar = (props:MenuProp) => {
  return (
    <div className="pl-20 pt-5 text-sm">
      ...
      <h1  className="text-gray-400 text-sm">Advertise . Press .</h1>
      <h1  className="text-gray-400 text-sm">Your Ad Choices .</h1> 
      <h1  className="text-gray-400 text-sm">Grievance Officer</h1>
    </div>
  )
}
